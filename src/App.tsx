      ...
      <nav className="border-b border-[#1E1E22] bg-[#0B0B0D]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="px-6 py-2 bg-[#E10600] hover:bg-[#9B0500] text-[#F5F6FA] font-medium rounded transition-all shadow-button-3d hover:shadow-red-glow">
              Connect Wallet
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-[#E10600] hover:bg-[#9B0500] text-[#F5F6FA] font-semibold text-lg rounded-lg transition-all shadow-button-3d hover:shadow-red-glow">
                Start Executing
              </button>
              <button className="px-8 py-4 bg-[#131316] hover:bg-[#1E1E22] text-[#F5F6FA] font-semibold text-lg rounded-lg border border-[#1E1E22] transition-all shadow-card">
                Explore Marketplace
              </button>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-8 bg-[#0B0B0D] rounded-lg border-2 border-[#E10600]/30 shadow-deep-3d relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <button className="w-full px-6 py-3 bg-[#E10600] hover:bg-[#9B0500] text-[#F5F6FA] font-semibold rounded-lg transition-all shadow-button-3d hover:shadow-red-glow">
                  Start Executing
                </button>
              </div>
            </div>
            ...
            <div className="p-8 bg-[#0B0B0D] rounded-lg border border-[#1E1E22] shadow-card">
              ...
              <button className="w-full px-6 py-3 bg-[#131316] hover:bg-[#1E1E22] text-[#F5F6FA] font-semibold rounded-lg border border-[#1E1E22] transition-all shadow-card">
                Explore Marketplace
              </button>
            </div>
          </div>
      ...
      <section className="py-20 bg-[#131316] border-t border-[#1E1E22]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="px-8 py-4 bg-[#0B0B0D] hover:bg-[#1E1E22] text-[#F5F6FA] font-semibold text-lg rounded-lg border border-[#1E1E22] transition-all shadow-card">
              Read Documentation
            </button>
          </div>
